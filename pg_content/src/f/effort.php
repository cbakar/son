...
<div id="esfLine"></div>
<div id="main_page">
  <form class="forumContanier" action="php/addEffort.php" method="post" autocomplete="on">
		...
		<?php
		    if( isset( $_SESSION['responsID'])){
		    	...
		    	switch ($_SESSION['responsID']) {
		    		...
		    		case 'effData_err':
		    			echo 'style="width:556px; visibility: visible; background-color: #FF0000;"> Data Error() - Record not added.';
		    			$_SESSION['responsID'] = null;
		    		break;
